...
- Explain the core principles of Quantization - Part 2
...
This lesson develops practical concepts for Quantization - Part 2 in real project workflows.
...
**Exercise 4.3.2.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.3.2.2**: Implement one baseline workflow step.
**Exercise 4.3.2.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.3.2.4**: Refactor one step into a reusable function.
**Exercise 4.3.2.5**: Compare two model or configuration options.
**Exercise 4.3.2.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.3.2.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.3.2.8**: Diagnose one failure case and propose a fix.
**Exercise 4.3.2.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 4.3.2.1 - 4.3.2.9
