# Lesson 4.3.36: Mini-Project: Inference Optimization Workflow

> Previous Lesson: [Lesson 4.3.35: Vector Retrieval - Part 35](Lesson-4.3.35-Vector-Retrieval-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 4.3.35 | **Topic**: 4.3 Production LLM Systems (Inference Optimization)
...
- Explain the core principles of Mini-Project: Inference Optimization Workflow
...
Mini-Project: Inference Optimization Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Inference Optimization Workflow in real project workflows.
...
1. Set explicit SLOs for Mini-Project: Inference Optimization Workflow (p95 latency, throughput).
...
```python
LESSON_ID = "4.3.36"
LESSON_TOPIC = "4.3 Production LLM Systems (Inference Optimization)"
...
**Exercise 4.3.36.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.3.36.2**: Implement one baseline workflow step.
**Exercise 4.3.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.3.36.4**: Refactor one step into a reusable function.
**Exercise 4.3.36.5**: Compare two model or configuration options.
**Exercise 4.3.36.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.3.36.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.3.36.8**: Diagnose one failure case and propose a fix.
**Exercise 4.3.36.9**: Add one robustness check for edge cases.
...
**Lesson 4.3.37: Quantization - Part 37**
...
- [ ] Complete exercises 4.3.36.1 - 4.3.36.9
...
Proceed to **Lesson 4.3.37: Quantization - Part 37** when ready.
