...
> Previous Lesson: [Lesson 4.2.11: Distributed Training - Part 11](Lesson-4.2.11-Distributed-Training-Part-11.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 4.2.11 | **Topic**: 4.2 Fine-tuning Methodologies (LoRA)
...
**Exercise 4.2.12.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.2.12.2**: Implement one baseline workflow step.
**Exercise 4.2.12.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.2.12.4**: Refactor one step into a reusable function.
**Exercise 4.2.12.5**: Compare two model or configuration options.
**Exercise 4.2.12.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.2.12.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.2.12.8**: Diagnose one failure case and propose a fix.
**Exercise 4.2.12.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 4.2.12.1 - 4.2.12.9
...
Proceed to **Lesson 4.2.13: QLoRA - Part 13** when ready.
