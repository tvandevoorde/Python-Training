# Lesson 4.2.24: Mini-Project: SFT Workflow

> Previous Lesson: [Lesson 4.2.23: Prompt Tuning - Part 23](Lesson-4.2.23-Prompt-Tuning-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 4.2.23 | **Topic**: 4.2 Fine-tuning Methodologies (SFT)
...
- Explain the core principles of Mini-Project: SFT Workflow
...
Mini-Project: SFT Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: SFT Workflow in real project workflows.
...
1. Pick one baseline model and one fine-tuning method for Mini-Project: SFT Workflow.
...
```python
LESSON_ID = "4.2.24"
LESSON_TOPIC = "4.2 Fine-tuning Methodologies (SFT)"
...
**Exercise 4.2.24.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.2.24.2**: Implement one baseline workflow step.
**Exercise 4.2.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.2.24.4**: Refactor one step into a reusable function.
**Exercise 4.2.24.5**: Compare two model or configuration options.
**Exercise 4.2.24.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.2.24.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.2.24.8**: Diagnose one failure case and propose a fix.
**Exercise 4.2.24.9**: Add one robustness check for edge cases.
...
**Lesson 4.2.25: MILESTONE TEST: 4.2 Fine-tuning Methodologies Module 1**
...
- [ ] Complete exercises 4.2.24.1 - 4.2.24.9
...
Proceed to **Lesson 4.2.25: MILESTONE TEST: 4.2 Fine-tuning Methodologies Module 1** when ready.
