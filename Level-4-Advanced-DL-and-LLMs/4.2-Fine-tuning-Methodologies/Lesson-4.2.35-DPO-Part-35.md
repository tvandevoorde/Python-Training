...
- Explain the core principles of DPO - Part 35
...
This lesson develops practical concepts for DPO - Part 35 in real project workflows.
...
**Exercise 4.2.35.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.2.35.2**: Implement one baseline workflow step.
**Exercise 4.2.35.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.2.35.4**: Refactor one step into a reusable function.
**Exercise 4.2.35.5**: Compare two model or configuration options.
**Exercise 4.2.35.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.2.35.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.2.35.8**: Diagnose one failure case and propose a fix.
**Exercise 4.2.35.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 4.2.35.1 - 4.2.35.9
