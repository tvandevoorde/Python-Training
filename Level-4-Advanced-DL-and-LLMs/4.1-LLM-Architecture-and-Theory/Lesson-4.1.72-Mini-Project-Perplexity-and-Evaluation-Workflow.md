# Lesson 4.1.72: Mini-Project: Perplexity and Evaluation Workflow

> Previous Lesson: [Lesson 4.1.71: Scaling Laws - Part 71](Lesson-4.1.71-Scaling-Laws-Part-71.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 4.1.71 | **Topic**: 4.1 LLM Architecture and Theory (Perplexity and Evaluation)
...
**Exercise 4.1.72.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.1.72.2**: Implement one baseline workflow step.
**Exercise 4.1.72.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.1.72.4**: Refactor one step into a reusable function.
**Exercise 4.1.72.5**: Compare two model or configuration options.
**Exercise 4.1.72.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.1.72.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.1.72.8**: Diagnose one failure case and propose a fix.
**Exercise 4.1.72.9**: Add one robustness check for edge cases.
...
**Lesson 4.1.73: Transformer Internals - Part 73**
...
- [ ] Complete exercises 4.1.72.1 - 4.1.72.9
...
Proceed to **Lesson 4.1.73: Transformer Internals - Part 73** when ready.
