# Lesson 4.1.48: Mini-Project: Perplexity and Evaluation Workflow

> Previous Lesson: [Lesson 4.1.47: Scaling Laws - Part 47](Lesson-4.1.47-Scaling-Laws-Part-47.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 4.1.47 | **Topic**: 4.1 LLM Architecture and Theory (Perplexity and Evaluation)
...
**Exercise 4.1.48.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.1.48.2**: Implement one baseline workflow step.
**Exercise 4.1.48.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.1.48.4**: Refactor one step into a reusable function.
**Exercise 4.1.48.5**: Compare two model or configuration options.
**Exercise 4.1.48.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.1.48.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.1.48.8**: Diagnose one failure case and propose a fix.
**Exercise 4.1.48.9**: Add one robustness check for edge cases.
...
**Lesson 4.1.49: Transformer Internals - Part 49**
...
- [ ] Complete exercises 4.1.48.1 - 4.1.48.9
...
Proceed to **Lesson 4.1.49: Transformer Internals - Part 49** when ready.
