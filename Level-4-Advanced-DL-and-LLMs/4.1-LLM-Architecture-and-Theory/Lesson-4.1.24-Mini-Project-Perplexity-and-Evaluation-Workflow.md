# Lesson 4.1.24: Mini-Project: Perplexity and Evaluation Workflow

> Previous Lesson: [Lesson 4.1.23: Scaling Laws - Part 23](Lesson-4.1.23-Scaling-Laws-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 4.1.23 | **Topic**: 4.1 LLM Architecture and Theory (Perplexity and Evaluation)
...
- Explain the core principles of Mini-Project: Perplexity and Evaluation Workflow
...
Mini-Project: Perplexity and Evaluation Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Perplexity and Evaluation Workflow in real project workflows.
...
1. Write a clear task contract for 4.1 LLM Architecture and Theory (Perplexity and Evaluation).
...
```python
LESSON_ID = "4.1.24"
LESSON_TOPIC = "4.1 LLM Architecture and Theory (Perplexity and Evaluation)"
...
**Exercise 4.1.24.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 4.1.24.2**: Implement one baseline workflow step.
**Exercise 4.1.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 4.1.24.4**: Refactor one step into a reusable function.
**Exercise 4.1.24.5**: Compare two model or configuration options.
**Exercise 4.1.24.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 4.1.24.7**: Add cross-validation or repeated-eval logic.
**Exercise 4.1.24.8**: Diagnose one failure case and propose a fix.
**Exercise 4.1.24.9**: Add one robustness check for edge cases.
...
**Lesson 4.1.25: MILESTONE TEST: 4.1 LLM Architecture and Theory Module 1**
- Continue the LLM system progression.

---

## Homework

- [ ] Complete exercises 4.1.24.1 - 4.1.24.9
...
Proceed to **Lesson 4.1.25: MILESTONE TEST: 4.1 LLM Architecture and Theory Module 1** when ready.
