...
> Previous Lesson: [Lesson 3.4.23: Experiment Tracking - Part 23](Lesson-3.4.23-Experiment-Tracking-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 3.4.23 | **Topic**: 3.4 Deep Learning Projects (Model Serving)
...
- Explain the core principles of Mini-Project: Model Serving Workflow
...
Mini-Project: Model Serving Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Model Serving Workflow in real project workflows.
...
1. Set explicit SLOs for Mini-Project: Model Serving Workflow (p95 latency, throughput).
...
**Exercise 3.4.24.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.4.24.2**: Implement one baseline workflow step.
**Exercise 3.4.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.4.24.4**: Refactor one step into a reusable function.
**Exercise 3.4.24.5**: Compare two model or configuration options.
**Exercise 3.4.24.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.4.24.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.4.24.8**: Diagnose one failure case and propose a fix.
**Exercise 3.4.24.9**: Add one robustness check for edge cases.
...
**Lesson 3.4.25: MILESTONE TEST: 3.4 Deep Learning Projects Module 1**
...
- [ ] Complete exercises 3.4.24.1 - 3.4.24.9
...
Proceed to **Lesson 3.4.25: MILESTONE TEST: 3.4 Deep Learning Projects Module 1** when ready.
