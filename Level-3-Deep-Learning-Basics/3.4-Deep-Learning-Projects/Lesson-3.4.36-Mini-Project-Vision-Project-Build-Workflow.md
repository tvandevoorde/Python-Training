# Lesson 3.4.36: Mini-Project: Vision Project Build Workflow

> Previous Lesson: [Lesson 3.4.35: Kaggle DL Workflow - Part 35](Lesson-3.4.35-Kaggle-DL-Workflow-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 3.4.35 | **Topic**: 3.4 Deep Learning Projects (Vision Project Build)
...
- Explain the core principles of Mini-Project: Vision Project Build Workflow
...
Mini-Project: Vision Project Build Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Vision Project Build Workflow in real project workflows.
...
1. Clarify one concrete goal for: Mini-Project: Vision Project Build Workflow.
2. Implement the smallest working version for: 3.4 Deep Learning Projects (Vision Project Build).
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "3.4.36"
LESSON_TOPIC = "Mini-Project: Vision Project Build Workflow"
...
**Exercise 3.4.36.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.4.36.2**: Implement one baseline workflow step.
**Exercise 3.4.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.4.36.4**: Refactor one step into a reusable function.
**Exercise 3.4.36.5**: Compare two model or configuration options.
**Exercise 3.4.36.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.4.36.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.4.36.8**: Diagnose one failure case and propose a fix.
**Exercise 3.4.36.9**: Add one robustness check for edge cases.
...
**Lesson 3.4.37: NLP Project Build - Part 37**
...
- [ ] Complete exercises 3.4.36.1 - 3.4.36.9
...
Proceed to **Lesson 3.4.37: NLP Project Build - Part 37** when ready.
