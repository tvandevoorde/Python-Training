# Lesson 3.4.1: 3.4 Deep Learning Projects: Big Picture

> Previous Lesson: [Sublevel Index](CURRICULUM-INDEX.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Sublevel .3 completion | **Topic**: 3.4 Deep Learning Projects (Vision Project Build)
...
- Explain the core principles of 3.4 Deep Learning Projects: Big Picture
...
3.4 Deep Learning Projects: Big Picture matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for 3.4 Deep Learning Projects: Big Picture in real project workflows.
...
1. Clarify one concrete goal for: 3.4 Deep Learning Projects: Big Picture.
...
```python
LESSON_ID = "3.4.1"
LESSON_TOPIC = "3.4 Deep Learning Projects: Big Picture"
...
**Exercise 3.4.1.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.4.1.2**: Implement one baseline workflow step.
**Exercise 3.4.1.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.4.1.4**: Refactor one step into a reusable function.
**Exercise 3.4.1.5**: Compare two model or configuration options.
**Exercise 3.4.1.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.4.1.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.4.1.8**: Diagnose one failure case and propose a fix.
**Exercise 3.4.1.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 3.4.1.1 - 3.4.1.9
...
Proceed to **Lesson 3.4.2: NLP Project Build - Part 2** when ready.
