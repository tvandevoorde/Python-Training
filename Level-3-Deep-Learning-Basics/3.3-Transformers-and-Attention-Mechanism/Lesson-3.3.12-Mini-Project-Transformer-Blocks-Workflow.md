# Lesson 3.3.12: Mini-Project: Transformer Blocks Workflow

> Previous Lesson: [Lesson 3.3.11: Positional Encoding - Part 11](Lesson-3.3.11-Positional-Encoding-Part-11.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 3.3.11 | **Topic**: 3.3 Transformers and Attention Mechanism (Transformer Blocks)
...
**Exercise 3.3.12.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.3.12.2**: Implement one baseline workflow step.
**Exercise 3.3.12.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.3.12.4**: Refactor one step into a reusable function.
**Exercise 3.3.12.5**: Compare two model or configuration options.
**Exercise 3.3.12.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.3.12.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.3.12.8**: Diagnose one failure case and propose a fix.
**Exercise 3.3.12.9**: Add one robustness check for edge cases.
...
**Lesson 3.3.13: Tokenization - Part 13**
...
- [ ] Complete exercises 3.3.12.1 - 3.3.12.9
...
Proceed to **Lesson 3.3.13: Tokenization - Part 13** when ready.
