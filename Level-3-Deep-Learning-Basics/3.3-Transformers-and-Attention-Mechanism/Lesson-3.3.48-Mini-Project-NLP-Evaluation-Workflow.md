# Lesson 3.3.48: Mini-Project: NLP Evaluation Workflow

> Previous Lesson: [Lesson 3.3.47: Fine-Tuning - Part 47](Lesson-3.3.47-Fine-Tuning-Part-47.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 3.3.47 | **Topic**: 3.3 Transformers and Attention Mechanism (NLP Evaluation)
...
**Exercise 3.3.48.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.3.48.2**: Implement one baseline workflow step.
**Exercise 3.3.48.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.3.48.4**: Refactor one step into a reusable function.
**Exercise 3.3.48.5**: Compare two model or configuration options.
**Exercise 3.3.48.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.3.48.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.3.48.8**: Diagnose one failure case and propose a fix.
**Exercise 3.3.48.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 3.3.48.1 - 3.3.48.9
...
Proceed to **Lesson 3.3.49: Self-Attention - Part 49** when ready.
