...
> Previous Lesson: [Lesson 3.2.1: 3.2 Convolutional and Recurrent Networks: Big Picture](Lesson-3.2.1-3-2-Convolutional-and-Recurrent-Networks-Big-Picture.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 3.2.1 | **Topic**: 3.2 Convolutional and Recurrent Networks (CNN Architectures)
...
- Explain the core principles of CNN Architectures - Part 2
...
CNN Architectures - Part 2 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for CNN Architectures - Part 2 in real project workflows.
...
1. Clarify one concrete goal for: CNN Architectures - Part 2.
...
```python
LESSON_ID = "3.2.2"
LESSON_TOPIC = "CNN Architectures - Part 2"
...
**Exercise 3.2.2.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.2.2.2**: Implement one baseline workflow step.
**Exercise 3.2.2.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.2.2.4**: Refactor one step into a reusable function.
**Exercise 3.2.2.5**: Compare two model or configuration options.
**Exercise 3.2.2.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.2.2.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.2.2.8**: Diagnose one failure case and propose a fix.
**Exercise 3.2.2.9**: Add one robustness check for edge cases.
...
**Lesson 3.2.3: Transfer Learning - Part 3**
...
- [ ] Complete exercises 3.2.2.1 - 3.2.2.9
...
Proceed to **Lesson 3.2.3: Transfer Learning - Part 3** when ready.
