# Lesson 3.2.36: Mini-Project: RNN Foundations Workflow

> Previous Lesson: [Lesson 3.2.35: Transfer Learning - Part 35](Lesson-3.2.35-Transfer-Learning-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 3.2.35 | **Topic**: 3.2 Convolutional and Recurrent Networks (RNN Foundations)
...
**Exercise 3.2.36.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.2.36.2**: Implement one baseline workflow step.
**Exercise 3.2.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.2.36.4**: Refactor one step into a reusable function.
**Exercise 3.2.36.5**: Compare two model or configuration options.
**Exercise 3.2.36.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.2.36.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.2.36.8**: Diagnose one failure case and propose a fix.
**Exercise 3.2.36.9**: Add one robustness check for edge cases.
...
**Lesson 3.2.37: LSTM and GRU - Part 37**
...
- [ ] Complete exercises 3.2.36.1 - 3.2.36.9
...
Proceed to **Lesson 3.2.37: LSTM and GRU - Part 37** when ready.
