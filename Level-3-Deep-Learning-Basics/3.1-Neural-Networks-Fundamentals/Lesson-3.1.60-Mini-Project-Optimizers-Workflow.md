# Lesson 3.1.60: Mini-Project: Optimizers Workflow

> Previous Lesson: [Lesson 3.1.59: Loss Functions - Part 59](Lesson-3.1.59-Loss-Functions-Part-59.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 3.1.59 | **Topic**: 3.1 Neural Networks Fundamentals (Optimizers)
...
**Exercise 3.1.60.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.1.60.2**: Implement one baseline workflow step.
**Exercise 3.1.60.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.1.60.4**: Refactor one step into a reusable function.
**Exercise 3.1.60.5**: Compare two model or configuration options.
**Exercise 3.1.60.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.1.60.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.1.60.8**: Diagnose one failure case and propose a fix.
**Exercise 3.1.60.9**: Add one robustness check for edge cases.
...
**Lesson 3.1.61: Normalization - Part 61**
...
- [ ] Complete exercises 3.1.60.1 - 3.1.60.9
...
Proceed to **Lesson 3.1.61: Normalization - Part 61** when ready.
