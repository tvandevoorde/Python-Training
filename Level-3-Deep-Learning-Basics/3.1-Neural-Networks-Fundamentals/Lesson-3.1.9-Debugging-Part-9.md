...
- Explain the core principles of Debugging - Part 9
...
This lesson develops practical concepts for Debugging - Part 9 in real project workflows.
...
**Exercise 3.1.9.1**: Build a minimal reproducible setup.
```python
import random
import numpy as np
...
**Exercise 3.1.9.2**: Implement one baseline workflow step.
**Exercise 3.1.9.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 3.1.9.4**: Refactor one step into a reusable function.
**Exercise 3.1.9.5**: Compare two model or configuration options.
**Exercise 3.1.9.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 3.1.9.7**: Add cross-validation or repeated-eval logic.
**Exercise 3.1.9.8**: Diagnose one failure case and propose a fix.
**Exercise 3.1.9.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 3.1.9.1 - 3.1.9.9
