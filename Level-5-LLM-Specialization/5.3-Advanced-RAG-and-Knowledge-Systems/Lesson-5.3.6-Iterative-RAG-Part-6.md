...
> Previous Lesson: [Lesson 5.3.5: Schema Extraction - Part 5](Lesson-5.3.5-Schema-Extraction-Part-5.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.3.5 | **Topic**: 5.3 Advanced RAG and Knowledge Systems (Iterative RAG)
...
- Explain the core principles of Iterative RAG - Part 6
...
Iterative RAG - Part 6 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Iterative RAG - Part 6 in real project workflows.
...
1. Define the retrieval objective for Iterative RAG - Part 6 (precision vs recall).
...
**Exercise 5.3.6.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.3.6.2**: Implement one baseline workflow step.
**Exercise 5.3.6.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.3.6.4**: Refactor one step into a reusable function.
**Exercise 5.3.6.5**: Compare two model or configuration options.
**Exercise 5.3.6.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.3.6.7**: Add repeated-evaluation logic.
**Exercise 5.3.6.8**: Diagnose one failure case and propose a fix.
**Exercise 5.3.6.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 5.3.6.1 - 5.3.6.9
...
Proceed to **Lesson 5.3.7: Knowledge Evaluation - Part 7** when ready.
