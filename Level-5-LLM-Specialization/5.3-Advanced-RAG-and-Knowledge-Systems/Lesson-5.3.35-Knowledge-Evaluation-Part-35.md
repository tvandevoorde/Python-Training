# Lesson 5.3.35: Knowledge Evaluation - Part 35

> Previous Lesson: [Lesson 5.3.34: Iterative RAG - Part 34](Lesson-5.3.34-Iterative-RAG-Part-34.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 5.3.34 | **Topic**: 5.3 Advanced RAG and Knowledge Systems (Knowledge Evaluation)
...
- Explain the core principles of Knowledge Evaluation - Part 35
...
Knowledge Evaluation - Part 35 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Knowledge Evaluation - Part 35 in real project workflows.
...
1. Define the retrieval objective for Knowledge Evaluation - Part 35 (precision vs recall).
...
**Exercise 5.3.35.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.3.35.2**: Implement one baseline workflow step.
**Exercise 5.3.35.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.3.35.4**: Refactor one step into a reusable function.
**Exercise 5.3.35.5**: Compare two model or configuration options.
**Exercise 5.3.35.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.3.35.7**: Add repeated-evaluation logic.
**Exercise 5.3.35.8**: Diagnose one failure case and propose a fix.
**Exercise 5.3.35.9**: Add one robustness check for edge cases.
...
**Lesson 5.3.36: Mini-Project: Embedding Strategy Workflow**
...
- [ ] Complete exercises 5.3.35.1 - 5.3.35.9
...
Proceed to **Lesson 5.3.36: Mini-Project: Embedding Strategy Workflow** when ready.
