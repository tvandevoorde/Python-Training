# Lesson 5.3.4: Chunking Design - Part 4

> Previous Lesson: [Lesson 5.3.3: Reranking - Part 3](Lesson-5.3.3-Reranking-Part-3.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.3.3 | **Topic**: 5.3 Advanced RAG and Knowledge Systems (Chunking Design)
...
- Explain the core principles of Chunking Design - Part 4
...
Chunking Design - Part 4 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Chunking Design - Part 4 in real project workflows.
...
1. Define the retrieval objective for Chunking Design - Part 4 (precision vs recall).
...
**Exercise 5.3.4.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.3.4.2**: Implement one baseline workflow step.
**Exercise 5.3.4.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.3.4.4**: Refactor one step into a reusable function.
**Exercise 5.3.4.5**: Compare two model or configuration options.
**Exercise 5.3.4.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.3.4.7**: Add repeated-evaluation logic.
**Exercise 5.3.4.8**: Diagnose one failure case and propose a fix.
**Exercise 5.3.4.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 5.3.4.1 - 5.3.4.9
...
Proceed to **Lesson 5.3.5: Schema Extraction - Part 5** when ready.
