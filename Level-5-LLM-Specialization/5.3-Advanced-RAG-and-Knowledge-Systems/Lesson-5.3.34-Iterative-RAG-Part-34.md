...
> Previous Lesson: [Lesson 5.3.33: Schema Extraction - Part 33](Lesson-5.3.33-Schema-Extraction-Part-33.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 5.3.33 | **Topic**: 5.3 Advanced RAG and Knowledge Systems (Iterative RAG)
...
- Explain the core principles of Iterative RAG - Part 34
...
Iterative RAG - Part 34 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Iterative RAG - Part 34 in real project workflows.
...
1. Define the retrieval objective for Iterative RAG - Part 34 (precision vs recall).
...
**Exercise 5.3.34.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.3.34.2**: Implement one baseline workflow step.
**Exercise 5.3.34.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.3.34.4**: Refactor one step into a reusable function.
**Exercise 5.3.34.5**: Compare two model or configuration options.
**Exercise 5.3.34.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.3.34.7**: Add repeated-evaluation logic.
**Exercise 5.3.34.8**: Diagnose one failure case and propose a fix.
**Exercise 5.3.34.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 5.3.34.1 - 5.3.34.9
...
Proceed to **Lesson 5.3.35: Knowledge Evaluation - Part 35** when ready.
