# Lesson 5.4.60: Mini-Project: Agent Automation Track Workflow

> Previous Lesson: [Lesson 5.4.59: Domain Application Track - Part 59](Lesson-5.4.59-Domain-Application-Track-Part-59.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 5.4.59 | **Topic**: 5.4 Capstone and Specialization (Agent Automation Track)
...
- Explain the core principles of Mini-Project: Agent Automation Track Workflow
...
Mini-Project: Agent Automation Track Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Agent Automation Track Workflow in real project workflows.
...
1. Write a strict plan-execute-observe loop for Mini-Project: Agent Automation Track Workflow.
...
```python
LESSON_ID = "5.4.60"
LESSON_TOPIC = "5.4 Capstone and Specialization (Agent Automation Track)"
...
**Exercise 5.4.60.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.4.60.2**: Implement one baseline workflow step.
**Exercise 5.4.60.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.4.60.4**: Refactor one step into a reusable function.
**Exercise 5.4.60.5**: Compare two model or configuration options.
**Exercise 5.4.60.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.4.60.7**: Add repeated-evaluation logic.
**Exercise 5.4.60.8**: Diagnose one failure case and propose a fix.
**Exercise 5.4.60.9**: Add one robustness check for edge cases.
...
**Lesson 5.4.61: Benchmarking - Part 61**
...
- [ ] Complete exercises 5.4.60.1 - 5.4.60.9
...
Proceed to **Lesson 5.4.61: Benchmarking - Part 61** when ready.
