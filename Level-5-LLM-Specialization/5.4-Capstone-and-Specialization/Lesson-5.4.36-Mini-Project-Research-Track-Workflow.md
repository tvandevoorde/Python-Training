# Lesson 5.4.36: Mini-Project: Research Track Workflow

> Previous Lesson: [Lesson 5.4.35: Technical Writing - Part 35](Lesson-5.4.35-Technical-Writing-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 5.4.35 | **Topic**: 5.4 Capstone and Specialization (Research Track)
...
- Explain the core principles of Mini-Project: Research Track Workflow
...
Mini-Project: Research Track Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Research Track Workflow in real project workflows.
...
1. Clarify one concrete goal for: Mini-Project: Research Track Workflow.
2. Implement the smallest working version for: 5.4 Capstone and Specialization (Research Track).
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "5.4.36"
LESSON_TOPIC = "Mini-Project: Research Track Workflow"
...
**Exercise 5.4.36.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.4.36.2**: Implement one baseline workflow step.
**Exercise 5.4.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.4.36.4**: Refactor one step into a reusable function.
**Exercise 5.4.36.5**: Compare two model or configuration options.
**Exercise 5.4.36.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.4.36.7**: Add repeated-evaluation logic.
**Exercise 5.4.36.8**: Diagnose one failure case and propose a fix.
**Exercise 5.4.36.9**: Add one robustness check for edge cases.
...
**Lesson 5.4.37: LLMOps Track - Part 37**
...
- [ ] Complete exercises 5.4.36.1 - 5.4.36.9
...
Proceed to **Lesson 5.4.37: LLMOps Track - Part 37** when ready.
