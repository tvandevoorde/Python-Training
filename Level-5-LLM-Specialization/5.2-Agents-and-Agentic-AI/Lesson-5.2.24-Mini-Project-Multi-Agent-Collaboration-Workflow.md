# Lesson 5.2.24: Mini-Project: Multi-Agent Collaboration Workflow

> Previous Lesson: [Lesson 5.2.23: LlamaIndex Workflows - Part 23](Lesson-5.2.23-LlamaIndex-Workflows-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 5.2.23 | **Topic**: 5.2 Agents and Agentic AI (Multi-Agent Collaboration)
...
**Exercise 5.2.24.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.24.2**: Implement one baseline workflow step.
**Exercise 5.2.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.24.4**: Refactor one step into a reusable function.
**Exercise 5.2.24.5**: Compare two model or configuration options.
**Exercise 5.2.24.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.24.7**: Add repeated-evaluation logic.
**Exercise 5.2.24.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.24.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 5.2.24.1 - 5.2.24.9
...
Proceed to **Lesson 5.2.25: MILESTONE TEST: 5.2 Agents and Agentic AI Module 1** when ready.
