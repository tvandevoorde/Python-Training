# Lesson 5.2.11: Prompting Strategies - Part 11

> Previous Lesson: [Lesson 5.2.10: Tool Calling - Part 10](Lesson-5.2.10-Tool-Calling-Part-10.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.2.10 | **Topic**: 5.2 Agents and Agentic AI (Prompting Strategies)
...
- Explain the core principles of Prompting Strategies - Part 11
...
Prompting Strategies - Part 11 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Prompting Strategies - Part 11 in real project workflows.
...
1. Write a strict plan-execute-observe loop for Prompting Strategies - Part 11.
...
**Exercise 5.2.11.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.11.2**: Implement one baseline workflow step.
**Exercise 5.2.11.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.11.4**: Refactor one step into a reusable function.
**Exercise 5.2.11.5**: Compare two model or configuration options.
**Exercise 5.2.11.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.11.7**: Add repeated-evaluation logic.
**Exercise 5.2.11.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.11.9**: Add one robustness check for edge cases.
...
**Lesson 5.2.12: Mini-Project: Chain-of-Thought Workflow**
...
- [ ] Complete exercises 5.2.11.1 - 5.2.11.9
...
Proceed to **Lesson 5.2.12: Mini-Project: Chain-of-Thought Workflow** when ready.
