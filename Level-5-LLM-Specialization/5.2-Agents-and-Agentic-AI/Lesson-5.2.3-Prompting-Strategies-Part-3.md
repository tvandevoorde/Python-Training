...
> Previous Lesson: [Lesson 5.2.2: Tool Calling - Part 2](Lesson-5.2.2-Tool-Calling-Part-2.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.2.2 | **Topic**: 5.2 Agents and Agentic AI (Prompting Strategies)
...
- Explain the core principles of Prompting Strategies - Part 3
...
Prompting Strategies - Part 3 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Prompting Strategies - Part 3 in real project workflows.
...
1. Write a strict plan-execute-observe loop for Prompting Strategies - Part 3.
...
**Exercise 5.2.3.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.3.2**: Implement one baseline workflow step.
**Exercise 5.2.3.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.3.4**: Refactor one step into a reusable function.
**Exercise 5.2.3.5**: Compare two model or configuration options.
**Exercise 5.2.3.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.3.7**: Add repeated-evaluation logic.
**Exercise 5.2.3.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.3.9**: Add one robustness check for edge cases.
...
**Lesson 5.2.4: Chain-of-Thought - Part 4**
...
- [ ] Complete exercises 5.2.3.1 - 5.2.3.9
...
Proceed to **Lesson 5.2.4: Chain-of-Thought - Part 4** when ready.
