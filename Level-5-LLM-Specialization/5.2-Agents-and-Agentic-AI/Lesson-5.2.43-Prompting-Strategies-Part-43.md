# Lesson 5.2.43: Prompting Strategies - Part 43

> Previous Lesson: [Lesson 5.2.42: Tool Calling - Part 42](Lesson-5.2.42-Tool-Calling-Part-42.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 5.2.42 | **Topic**: 5.2 Agents and Agentic AI (Prompting Strategies)
...
- Explain the core principles of Prompting Strategies - Part 43
...
Prompting Strategies - Part 43 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Prompting Strategies - Part 43 in real project workflows.
...
1. Write a strict plan-execute-observe loop for Prompting Strategies - Part 43.
...
**Exercise 5.2.43.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.43.2**: Implement one baseline workflow step.
**Exercise 5.2.43.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.43.4**: Refactor one step into a reusable function.
**Exercise 5.2.43.5**: Compare two model or configuration options.
**Exercise 5.2.43.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.43.7**: Add repeated-evaluation logic.
**Exercise 5.2.43.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.43.9**: Add one robustness check for edge cases.
...
**Lesson 5.2.44: Chain-of-Thought - Part 44**
...
- [ ] Complete exercises 5.2.43.1 - 5.2.43.9
...
Proceed to **Lesson 5.2.44: Chain-of-Thought - Part 44** when ready.
