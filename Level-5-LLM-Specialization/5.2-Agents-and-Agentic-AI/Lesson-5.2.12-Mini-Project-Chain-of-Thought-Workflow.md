...
> Previous Lesson: [Lesson 5.2.11: Prompting Strategies - Part 11](Lesson-5.2.11-Prompting-Strategies-Part-11.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.2.11 | **Topic**: 5.2 Agents and Agentic AI (Chain-of-Thought)
...
**Exercise 5.2.12.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.12.2**: Implement one baseline workflow step.
**Exercise 5.2.12.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.12.4**: Refactor one step into a reusable function.
**Exercise 5.2.12.5**: Compare two model or configuration options.
**Exercise 5.2.12.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.12.7**: Add repeated-evaluation logic.
**Exercise 5.2.12.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.12.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 5.2.12.1 - 5.2.12.9
...
Proceed to **Lesson 5.2.13: Tree-of-Thought - Part 13** when ready.
