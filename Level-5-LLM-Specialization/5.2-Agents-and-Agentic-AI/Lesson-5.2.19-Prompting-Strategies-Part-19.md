# Lesson 5.2.19: Prompting Strategies - Part 19

> Previous Lesson: [Lesson 5.2.18: Tool Calling - Part 18](Lesson-5.2.18-Tool-Calling-Part-18.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 5.2.18 | **Topic**: 5.2 Agents and Agentic AI (Prompting Strategies)
...
- Explain the core principles of Prompting Strategies - Part 19
...
Prompting Strategies - Part 19 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Prompting Strategies - Part 19 in real project workflows.
...
1. Write a strict plan-execute-observe loop for Prompting Strategies - Part 19.
...
**Exercise 5.2.19.1**: Build a minimal reproducible setup.
```python
import random
...
**Exercise 5.2.19.2**: Implement one baseline workflow step.
**Exercise 5.2.19.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 5.2.19.4**: Refactor one step into a reusable function.
**Exercise 5.2.19.5**: Compare two model or configuration options.
**Exercise 5.2.19.6**: Explain one quality tradeoff in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 5.2.19.7**: Add repeated-evaluation logic.
**Exercise 5.2.19.8**: Diagnose one failure case and propose a fix.
**Exercise 5.2.19.9**: Add one robustness check for edge cases.
...
**Lesson 5.2.20: Chain-of-Thought - Part 20**
...
- [ ] Complete exercises 5.2.19.1 - 5.2.19.9
...
Proceed to **Lesson 5.2.20: Chain-of-Thought - Part 20** when ready.
