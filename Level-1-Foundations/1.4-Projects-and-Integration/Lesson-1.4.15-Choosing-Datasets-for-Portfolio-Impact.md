# Lesson 1.4.15: Choosing Datasets for Portfolio Impact

> Previous Lesson: [Lesson 1.4.14: Portfolio Strategy and Storytelling](Lesson-1.4.14-Portfolio-Strategy-and-Storytelling.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.4.14 | **Topic**: Project 2 Foundations
...
- Explain key principles of Choosing Datasets for Portfolio Impact
...
Choosing Datasets for Portfolio Impact matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: Choosing Datasets for Portfolio Impact.
...
```python
LESSON_ID = "1.4.15"
LESSON_TOPIC = "Choosing Datasets for Portfolio Impact"
...
**Exercise 1.4.15.1**: Create a small input dataset and save it to CSV.
`python
import pandas as pd
...
**Exercise 1.4.15.2**: Add one validation check for missing values.
**Exercise 1.4.15.3**: Compute one grouped summary table.

---

### Difficulty 2: Intermediate

**Exercise 1.4.15.4**: Refactor one step into a reusable function.
**Exercise 1.4.15.5**: Write a failing test for bad input.
**Exercise 1.4.15.6**: Add structured logging for a pipeline stage.

---

### Difficulty 3: Advanced

**Exercise 1.4.15.7**: Add retry logic to a file read operation.
**Exercise 1.4.15.8**: Benchmark two implementation options.
**Exercise 1.4.15.9**: Document tradeoffs in a short design note.
...
**Lesson 1.4.16: EDA Workflow for Portfolio Project 1**
...
- [ ] Complete exercises 1.4.15.1 - 1.4.15.9
...
Proceed to **Lesson 1.4.16: EDA Workflow for Portfolio Project 1** when ready.
