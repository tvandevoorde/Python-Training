...
- Explain key principles of Projects and Integration - Big Picture
...
**Exercise 1.4.1.1**: Create a small input dataset and save it to CSV.
`python
import pandas as pd
...
**Exercise 1.4.1.2**: Add one validation check for missing values.
**Exercise 1.4.1.3**: Compute one grouped summary table.

---

### Difficulty 2: Intermediate

**Exercise 1.4.1.4**: Refactor one step into a reusable function.
**Exercise 1.4.1.5**: Write a failing test for bad input.
**Exercise 1.4.1.6**: Add structured logging for a pipeline stage.

---

### Difficulty 3: Advanced

**Exercise 1.4.1.7**: Add retry logic to a file read operation.
**Exercise 1.4.1.8**: Benchmark two implementation options.
**Exercise 1.4.1.9**: Document tradeoffs in a short design note.
...
- [ ] Complete exercises 1.4.1.1 - 1.4.1.9
