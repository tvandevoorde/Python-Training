...
> Previous Lesson: [Lesson 1.4.16: EDA Workflow for Portfolio Project 1](Lesson-1.4.16-EDA-Workflow-for-Portfolio-Project-1.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.4.16 | **Topic**: Project 2 Foundations
...
- Explain key principles of EDA Workflow for Portfolio Project 2
...
EDA Workflow for Portfolio Project 2 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: EDA Workflow for Portfolio Project 2.
...
```python
LESSON_ID = "1.4.17"
LESSON_TOPIC = "EDA Workflow for Portfolio Project 2"
...
**Exercise 1.4.17.1**: Create a small input dataset and save it to CSV.
`python
import pandas as pd
...
**Exercise 1.4.17.2**: Add one validation check for missing values.
**Exercise 1.4.17.3**: Compute one grouped summary table.

---

### Difficulty 2: Intermediate

**Exercise 1.4.17.4**: Refactor one step into a reusable function.
**Exercise 1.4.17.5**: Write a failing test for bad input.
**Exercise 1.4.17.6**: Add structured logging for a pipeline stage.

---

### Difficulty 3: Advanced

**Exercise 1.4.17.7**: Add retry logic to a file read operation.
**Exercise 1.4.17.8**: Benchmark two implementation options.
**Exercise 1.4.17.9**: Document tradeoffs in a short design note.
...
- [ ] Complete exercises 1.4.17.1 - 1.4.17.9
...
Proceed to **Lesson 1.4.18: EDA Workflow for Portfolio Project 3** when ready.
