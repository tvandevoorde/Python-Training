# LEVEL 1.4: Projects and Integration - Complete Lesson Index

**Total Time**: 200 hours | **Number of Lessons**: 25 lessons | **Lesson Duration**: ~8 hours each  
**Prerequisites**: LEVEL 1.3 (Data Science Tools) | **Target**: Build and present integrated data projects

---

## Overview

This subLevel converts foundational skills into project delivery capability through two major projects and one final Level 1 exercise project.

**Learning Path:**
1. Project 1 Foundations and Build (Lessons 1.4.1 - 1.4.13)
2. Project 2 Portfolio Foundations and Build (Lessons 1.4.14 - 1.4.24)
3. Final Level 1 Exercise Project (Lesson 1.4.25)

---

## Block 1: Project 1 - End-to-End Data Pipeline (104 hours / 13 lessons)
...
## Block 2: Project 2 - Personal Data Analysis Portfolio (96 hours / 12 lessons)
...
|------------|---------|-----------|------------|
| **Week 1-2** | 1.4.1 - 1.4.6 | Pipeline design readiness | design review |
| **Week 3-4** | 1.4.7 - 1.4.13 | Project 1 completion | project demo and rubric |
| **Week 5-6** | 1.4.14 - 1.4.20 | Portfolio analysis maturity | peer review |
...
- Build and deploy end-to-end data pipelines from raw data to insights
- Deliver a multi-project analysis portfolio with strong documentation
- Integrate Python, math, data science tools, and project engineering practices
- Present technical work clearly for hiring or academic evaluation

**Next Level**: LEVEL 2 - Machine Learning
