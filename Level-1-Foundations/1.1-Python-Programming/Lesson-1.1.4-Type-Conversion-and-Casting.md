...
> Previous Lesson: [Lesson 1.1.3: Input and String Formatting](Lesson-1.1.3-Input-and-String-Formatting.md)
...
Type Conversion & Casting matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: Type Conversion & Casting.
...
```python
LESSON_ID = "1.1.4"
LESSON_TOPIC = "Type Conversion & Casting"
