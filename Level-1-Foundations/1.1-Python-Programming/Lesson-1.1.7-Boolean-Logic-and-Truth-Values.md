...
> Previous Lesson: [Lesson 1.1.6: Special Numbers & Math](Lesson-1.1.6-Special-Numbers-and-Math.md)
...
Boolean Logic & Truth Values matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: Boolean Logic & Truth Values.
2. Implement the smallest working version for: Boolean Operators & Logic.
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "1.1.7"
LESSON_TOPIC = "Boolean Logic & Truth Values"
