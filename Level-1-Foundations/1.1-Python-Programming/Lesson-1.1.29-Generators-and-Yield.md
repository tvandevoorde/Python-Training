...
> Previous Lesson: [Lesson 1.1.28: Recursion Fundamentals](Lesson-1.1.28-Recursion-Fundamentals.md)
...
Generators & Yield matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: Generators & Yield.
2. Implement the smallest working version for: Functions - Generator Functions.
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "1.1.29"
LESSON_TOPIC = "Generators & Yield"
