...
> Previous Lesson: [Lesson 1.1.15: `while` Loops - Repetition](Lesson-1.1.15-while-Loop.md)
...
`for` Loops & `range()` matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: `for` Loops & `range()`.
2. Implement the smallest working version for: Loops - Alternative Loop Type.
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "1.1.16"
LESSON_TOPIC = "`for` Loops & `range()`"
