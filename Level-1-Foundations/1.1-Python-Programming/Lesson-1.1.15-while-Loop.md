...
> Previous Lesson: [Lesson 1.1.14: Ternary Operator](Lesson-1.1.14-Ternary-Operator.md)
...
`while` Loops - Repetition matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: `while` Loops - Repetition.
2. Implement the smallest working version for: Loops - Conditional Repetition.
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "1.1.15"
LESSON_TOPIC = "`while` Loops - Repetition"
