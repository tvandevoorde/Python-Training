...
> Previous Lesson: [Lesson 1.1.1: Intro to Python and Variables](Lesson-1.1.1-Intro-to-Python-and-Variables.md)
...
Operators (Arithmetic, Comparison, Logical) matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Clarify one concrete goal for: Operators (Arithmetic, Comparison, Logical).
...
```python
LESSON_ID = "1.1.2"
LESSON_TOPIC = "Operators (Arithmetic, Comparison, Logical)"
