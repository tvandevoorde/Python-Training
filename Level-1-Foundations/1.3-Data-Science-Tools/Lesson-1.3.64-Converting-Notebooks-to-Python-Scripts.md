# Lesson 1.3.64: Converting Notebooks to Python Scripts

> Previous Lesson: [Lesson 1.3.63: Debugging and Refactoring Notebook Code](Lesson-1.3.63-Debugging-and-Refactoring-Notebook-Code.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.3.63 | **Topic**: Jupyter Notebooks
...
- Explain the core idea behind "Converting Notebooks to Python Scripts"
...
Converting Notebooks to Python Scripts matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Start from a tiny sample that reflects Jupyter Notebooks.
...
LESSON_ID = "1.3.64"
LESSON_TOPIC = "Jupyter Notebooks"
...
**Exercise 1.3.64.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.64.2**: Compute the mean of one numeric column.
**Exercise 1.3.64.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.64.4**: Write a function that returns missing-value counts.
**Exercise 1.3.64.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.64.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.64.7**: Build a reusable function with input validation.
**Exercise 1.3.64.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.64.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.65: Version Control for Notebooks**
...
- [ ] Complete exercises 1.3.64.1 - 1.3.64.9
...
Proceed to **Lesson 1.3.65: Version Control for Notebooks** when ready.
```
