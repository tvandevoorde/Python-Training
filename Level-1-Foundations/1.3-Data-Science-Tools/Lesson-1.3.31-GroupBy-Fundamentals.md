...
> Previous Lesson: [Lesson 1.3.30: Datetime Basics in Pandas](Lesson-1.3.30-Datetime-Basics-in-Pandas.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.3.30 | **Topic**: Pandas Data Manipulation
...
- Explain the core idea behind "GroupBy Fundamentals"
...
GroupBy Fundamentals matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.31.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.31.2**: Compute the mean of one numeric column.
**Exercise 1.3.31.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.31.4**: Write a function that returns missing-value counts.
**Exercise 1.3.31.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.31.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.31.7**: Build a reusable function with input validation.
**Exercise 1.3.31.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.31.9**: Add logging and sanity checks to your workflow.
...
- [ ] Complete exercises 1.3.31.1 - 1.3.31.9
...
Proceed to **Lesson 1.3.32: GroupBy Aggregations** when ready.
```
