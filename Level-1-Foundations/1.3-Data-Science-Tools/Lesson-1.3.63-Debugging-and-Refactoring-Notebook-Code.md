...
- Explain the core idea behind "Debugging and Refactoring Notebook Code"
...
**Exercise 1.3.63.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.63.2**: Compute the mean of one numeric column.
**Exercise 1.3.63.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.63.4**: Write a function that returns missing-value counts.
**Exercise 1.3.63.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.63.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.63.7**: Build a reusable function with input validation.
**Exercise 1.3.63.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.63.9**: Add logging and sanity checks to your workflow.
...
- [ ] Complete exercises 1.3.63.1 - 1.3.63.9
