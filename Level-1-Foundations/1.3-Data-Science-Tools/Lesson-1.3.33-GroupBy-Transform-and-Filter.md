...
> Previous Lesson: [Lesson 1.3.32: GroupBy Aggregations](Lesson-1.3.32-GroupBy-Aggregations.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.3.32 | **Topic**: Pandas Data Manipulation
...
- Explain the core idea behind "GroupBy Transform and Filter"
...
GroupBy Transform and Filter matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.33.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.33.2**: Compute the mean of one numeric column.
**Exercise 1.3.33.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.33.4**: Write a function that returns missing-value counts.
**Exercise 1.3.33.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.33.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.33.7**: Build a reusable function with input validation.
**Exercise 1.3.33.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.33.9**: Add logging and sanity checks to your workflow.
...
- [ ] Complete exercises 1.3.33.1 - 1.3.33.9
...
Proceed to **Lesson 1.3.34: Pivot Tables and Crosstab** when ready.
```
