# Lesson 1.3.9: Sorting, Searching, and Unique Values

> Previous Lesson: [Lesson 1.3.8: Boolean Masking and Filtering](Lesson-1.3.8-Boolean-Masking-and-Filtering.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.3.8 | **Topic**: NumPy Mastery
...
- Explain the core idea behind "Sorting, Searching, and Unique Values"
...
Sorting, Searching, and Unique Values matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Start from a tiny sample that reflects NumPy Mastery.
...
**Exercise 1.3.9.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.9.2**: Compute the mean of one numeric column.
**Exercise 1.3.9.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.9.4**: Write a function that returns missing-value counts.
**Exercise 1.3.9.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.9.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.9.7**: Build a reusable function with input validation.
**Exercise 1.3.9.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.9.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.10: Random Sampling and Seeds**
...
- [ ] Complete exercises 1.3.9.1 - 1.3.9.9
...
Proceed to **Lesson 1.3.10: Random Sampling and Seeds** when ready.
```
