# Lesson 1.3.68: Mini-Project - Reproducible EDA Notebook

> Previous Lesson: [Lesson 1.3.67: Notebook Performance and Memory](Lesson-1.3.67-Notebook-Performance-and-Memory.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lessons 1.3.58 - 1.3.67 | **Topic**: Jupyter Integration
...
- Explain the core idea behind "Mini-Project - Reproducible EDA Notebook"
...
Mini-Project - Reproducible EDA Notebook matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Start from a tiny sample that reflects Jupyter Integration.
...
LESSON_ID = "1.3.68"
LESSON_TOPIC = "Jupyter Integration"
...
**Exercise 1.3.68.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.68.2**: Compute the mean of one numeric column.
**Exercise 1.3.68.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.68.4**: Write a function that returns missing-value counts.
**Exercise 1.3.68.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.68.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.68.7**: Build a reusable function with input validation.
**Exercise 1.3.68.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.68.9**: Add logging and sanity checks to your workflow.

---

## Mini-Project: Reproducible EDA Notebook
...
- [ ] Complete exercises 1.3.68.1 - 1.3.68.9
...
Proceed to **Lesson 1.3.69: MILESTONE TEST - Jupyter Notebooks** when ready.
```
