# Lesson 1.3.2: Arrays Basics and dtypes

> Previous Lesson: [Lesson 1.3.1: NumPy for Data Science - Big Picture](Lesson-1.3.1-NumPy-for-Data-Science-Big-Picture.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.3.1 | **Topic**: NumPy Mastery
...
- Explain the core idea behind "Arrays Basics and dtypes"
...
Arrays Basics and dtypes matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.2.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.2.2**: Compute the mean of one numeric column.
**Exercise 1.3.2.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.2.4**: Write a function that returns missing-value counts.
**Exercise 1.3.2.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.2.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.2.7**: Build a reusable function with input validation.
**Exercise 1.3.2.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.2.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.3: Array Creation Methods**
...
- [ ] Complete exercises 1.3.2.1 - 1.3.2.9
...
Proceed to **Lesson 1.3.3: Array Creation Methods** when ready.
```
