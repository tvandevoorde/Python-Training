# Lesson 1.3.35: Merging and Joining DataFrames

> Previous Lesson: [Lesson 1.3.34: Pivot Tables and Crosstab](Lesson-1.3.34-Pivot-Tables-and-Crosstab.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.3.34 | **Topic**: Pandas Data Manipulation
...
- Explain the core idea behind "Merging and Joining DataFrames"
...
Merging and Joining DataFrames matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.35.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.35.2**: Compute the mean of one numeric column.
**Exercise 1.3.35.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.35.4**: Write a function that returns missing-value counts.
**Exercise 1.3.35.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.35.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.35.7**: Build a reusable function with input validation.
**Exercise 1.3.35.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.35.9**: Add logging and sanity checks to your workflow.
...
- [ ] Complete exercises 1.3.35.1 - 1.3.35.9
...
Proceed to **Lesson 1.3.36: Concatenation Patterns** when ready.
```
