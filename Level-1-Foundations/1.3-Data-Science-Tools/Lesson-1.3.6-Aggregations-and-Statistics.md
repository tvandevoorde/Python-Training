...
> Previous Lesson: [Lesson 1.3.5: Reshaping and Axis Concepts](Lesson-1.3.5-Reshaping-and-Axis-Concepts.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.3.5 | **Topic**: NumPy Mastery
...
- Explain the core idea behind "Aggregations and Statistics"
...
Aggregations and Statistics matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.6.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.6.2**: Compute the mean of one numeric column.
**Exercise 1.3.6.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.6.4**: Write a function that returns missing-value counts.
**Exercise 1.3.6.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.6.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.6.7**: Build a reusable function with input validation.
**Exercise 1.3.6.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.6.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.7: Universal Functions**
...
- [ ] Complete exercises 1.3.6.1 - 1.3.6.9
...
Proceed to **Lesson 1.3.7: Universal Functions** when ready.
```
