# Lesson 1.3.5: Reshaping and Axis Concepts

> Previous Lesson: [Lesson 1.3.4: Indexing and Slicing](Lesson-1.3.4-Indexing-and-Slicing.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.3.4 | **Topic**: NumPy Mastery
...
- Explain the core idea behind "Reshaping and Axis Concepts"
...
Reshaping and Axis Concepts matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.5.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.5.2**: Compute the mean of one numeric column.
**Exercise 1.3.5.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.5.4**: Write a function that returns missing-value counts.
**Exercise 1.3.5.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.5.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.5.7**: Build a reusable function with input validation.
**Exercise 1.3.5.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.5.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.6: Aggregations and Statistics**
...
- [ ] Complete exercises 1.3.5.1 - 1.3.5.9
...
Proceed to **Lesson 1.3.6: Aggregations and Statistics** when ready.
```
