# Lesson 1.3.74: Mini-Project - Local Analytics Database

> Previous Lesson: [Lesson 1.3.73: GROUP BY and JOIN Fundamentals](Lesson-1.3.73-GROUP-BY-and-JOIN-Fundamentals.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lessons 1.3.70 - 1.3.73 | **Topic**: SQL Integration
...
- Explain the core idea behind "Mini-Project - Local Analytics Database"
...
Mini-Project - Local Analytics Database matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. Start from a tiny sample that reflects SQL Integration.
...
**Exercise 1.3.74.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.74.2**: Compute the mean of one numeric column.
**Exercise 1.3.74.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.74.4**: Write a function that returns missing-value counts.
**Exercise 1.3.74.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.74.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.74.7**: Build a reusable function with input validation.
**Exercise 1.3.74.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.74.9**: Add logging and sanity checks to your workflow.

---

## Mini-Project: Local Analytics Database
...
- [ ] Complete exercises 1.3.74.1 - 1.3.74.9
...
Proceed to **Lesson 1.3.75: CAPSTONE PROJECT - Exploratory Data Analysis on Real Dataset** when ready.
```
