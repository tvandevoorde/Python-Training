...
> Previous Lesson: [Lesson 1.3.25: Selecting Columns and Rows](Lesson-1.3.25-Selecting-Columns-and-Rows.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 1.3.25 | **Topic**: Pandas Data Manipulation
...
- Explain the core idea behind "loc and iloc Deep Dive"
...
loc and iloc Deep Dive matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.26.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.26.2**: Compute the mean of one numeric column.
**Exercise 1.3.26.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.26.4**: Write a function that returns missing-value counts.
**Exercise 1.3.26.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.26.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.26.7**: Build a reusable function with input validation.
**Exercise 1.3.26.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.26.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.27: Filtering and Querying**
...
- [ ] Complete exercises 1.3.26.1 - 1.3.26.9
...
Proceed to **Lesson 1.3.27: Filtering and Querying** when ready.
```
