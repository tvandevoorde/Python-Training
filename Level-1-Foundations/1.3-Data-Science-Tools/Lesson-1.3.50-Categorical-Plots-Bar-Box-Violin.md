...
> Previous Lesson: [Lesson 1.3.49: Scatter Plots and Correlation Visuals](Lesson-1.3.49-Scatter-Plots-and-Correlation-Visuals.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 1.3.49 | **Topic**: Matplotlib and Seaborn
...
- Explain the core idea behind "Categorical Plots: Bar, Box, Violin"
...
Categorical Plots: Bar, Box, Violin matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
**Exercise 1.3.50.1**: Create a small DataFrame and print its shape.
```python
import pandas as pd
...
**Exercise 1.3.50.2**: Compute the mean of one numeric column.
**Exercise 1.3.50.3**: Filter rows using a simple condition.

---

### Difficulty 2: Intermediate

**Exercise 1.3.50.4**: Write a function that returns missing-value counts.
**Exercise 1.3.50.5**: Group by one column and compute an aggregate metric.
**Exercise 1.3.50.6**: Plot one chart that supports a data insight.

---

### Difficulty 3: Advanced

**Exercise 1.3.50.7**: Build a reusable function with input validation.
**Exercise 1.3.50.8**: Compare two preprocessing strategies and summarize tradeoffs.
**Exercise 1.3.50.9**: Add logging and sanity checks to your workflow.
...
**Lesson 1.3.51: Subplots and Layout Systems**
...
- [ ] Complete exercises 1.3.50.1 - 1.3.50.9
...
Proceed to **Lesson 1.3.51: Subplots and Layout Systems** when ready.
```
