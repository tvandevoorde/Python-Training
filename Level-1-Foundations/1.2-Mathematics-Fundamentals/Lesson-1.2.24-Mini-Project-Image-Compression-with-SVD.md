...
> Previous Lesson: [Lesson 1.2.23: SVD Intuition](Lesson-1.2.23-SVD-Intuition.md)
...
Mini-Project - Image Compression with SVD matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. State the mathematical assumption behind Mini-Project - Image Compression with SVD.
...
LESSON_ID = "1.2.24"
LESSON_TOPIC = "Mini-Project - Image Compression with SVD"
