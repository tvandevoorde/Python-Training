...
> Previous Lesson: [Lesson 1.2.19: Eigenvalues and Eigenvectors](Lesson-1.2.19-Eigenvalues-and-Eigenvectors.md)
...
Eigen Decomposition matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
1. State the mathematical assumption behind Eigen Decomposition.
...
LESSON_ID = "1.2.20"
LESSON_TOPIC = "Eigen Decomposition"
