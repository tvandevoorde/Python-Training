# Lesson 2.2.72: Mini-Project: Hyperparameter Tuning Workflow

> Previous Lesson: [Lesson 2.2.71: Preprocessing Pipelines - Part 71](Lesson-2.2.71-Preprocessing-Pipelines-Part-71.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 2.2.71 | **Topic**: 2.2 Practical ML Engineering (Hyperparameter Tuning)
...
**Exercise 2.2.72.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.2.72.2**: Train one baseline model.
**Exercise 2.2.72.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.2.72.4**: Add one preprocessing step in a pipeline.
**Exercise 2.2.72.5**: Compare two models on the same split.
**Exercise 2.2.72.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.2.72.7**: Add cross-validation and summarize variance.
**Exercise 2.2.72.8**: Diagnose one model failure case.
**Exercise 2.2.72.9**: Add one robustness check for edge cases.
...
**Lesson 2.2.73: Model Diagnostics - Part 73**
...
- [ ] Complete exercises 2.2.72.1 - 2.2.72.9
...
Proceed to **Lesson 2.2.73: Model Diagnostics - Part 73** when ready.
