# Lesson 2.2.24: Mini-Project: Deployment Basics Workflow

> Previous Lesson: [Lesson 2.2.23: Model Diagnostics - Part 23](Lesson-2.2.23-Model-Diagnostics-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.2.23 | **Topic**: 2.2 Practical ML Engineering (Deployment Basics)
...
- Explain the core principles of Mini-Project: Deployment Basics Workflow
...
Mini-Project: Deployment Basics Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Deployment Basics Workflow in real machine learning projects.
...
1. Define service-level targets for Mini-Project: Deployment Basics Workflow (latency, error rate).
...
LESSON_ID = "2.2.24"
LESSON_TOPIC = "Mini-Project: Deployment Basics Workflow"
...
**Exercise 2.2.24.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.2.24.2**: Train one baseline model.
**Exercise 2.2.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.2.24.4**: Add one preprocessing step in a pipeline.
**Exercise 2.2.24.5**: Compare two models on the same split.
**Exercise 2.2.24.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.2.24.7**: Add cross-validation and summarize variance.
**Exercise 2.2.24.8**: Diagnose one model failure case.
**Exercise 2.2.24.9**: Add one robustness check for edge cases.
...
**Lesson 2.2.25: MILESTONE TEST: 2.2 Practical ML Engineering Module 1**
...
- [ ] Complete exercises 2.2.24.1 - 2.2.24.9
...
Proceed to **Lesson 2.2.25: MILESTONE TEST: 2.2 Practical ML Engineering Module 1** when ready.
