# Lesson 2.2.36: Mini-Project: Preprocessing Pipelines Workflow

> Previous Lesson: [Lesson 2.2.35: Monitoring and Reliability - Part 35](Lesson-2.2.35-Monitoring-and-Reliability-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.2.35 | **Topic**: 2.2 Practical ML Engineering (Preprocessing Pipelines)
...
- Explain the core principles of Mini-Project: Preprocessing Pipelines Workflow
...
Mini-Project: Preprocessing Pipelines Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Preprocessing Pipelines Workflow in real machine learning projects.
...
1. Clarify one concrete goal for: Mini-Project: Preprocessing Pipelines Workflow.
2. Implement the smallest working version for: 2.2 Practical ML Engineering (Preprocessing Pipelines).
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "2.2.36"
LESSON_TOPIC = "Mini-Project: Preprocessing Pipelines Workflow"
...
**Exercise 2.2.36.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.2.36.2**: Train one baseline model.
**Exercise 2.2.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.2.36.4**: Add one preprocessing step in a pipeline.
**Exercise 2.2.36.5**: Compare two models on the same split.
**Exercise 2.2.36.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.2.36.7**: Add cross-validation and summarize variance.
**Exercise 2.2.36.8**: Diagnose one model failure case.
**Exercise 2.2.36.9**: Add one robustness check for edge cases.
...
**Lesson 2.2.37: Hyperparameter Tuning - Part 37**
...
- [ ] Complete exercises 2.2.36.1 - 2.2.36.9
...
Proceed to **Lesson 2.2.37: Hyperparameter Tuning - Part 37** when ready.
