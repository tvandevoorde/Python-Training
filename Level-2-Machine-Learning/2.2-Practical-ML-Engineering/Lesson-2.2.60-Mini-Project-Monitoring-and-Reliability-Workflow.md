# Lesson 2.2.60: Mini-Project: Monitoring and Reliability Workflow

> Previous Lesson: [Lesson 2.2.59: Deployment Basics - Part 59](Lesson-2.2.59-Deployment-Basics-Part-59.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.2.59 | **Topic**: 2.2 Practical ML Engineering (Monitoring and Reliability)
...
- Explain the core principles of Mini-Project: Monitoring and Reliability Workflow
...
Mini-Project: Monitoring and Reliability Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Monitoring and Reliability Workflow in real machine learning projects.
...
1. Define service-level targets for Mini-Project: Monitoring and Reliability Workflow (latency, error rate).
...
LESSON_ID = "2.2.60"
LESSON_TOPIC = "Mini-Project: Monitoring and Reliability Workflow"
...
**Exercise 2.2.60.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.2.60.2**: Train one baseline model.
**Exercise 2.2.60.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.2.60.4**: Add one preprocessing step in a pipeline.
**Exercise 2.2.60.5**: Compare two models on the same split.
**Exercise 2.2.60.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.2.60.7**: Add cross-validation and summarize variance.
**Exercise 2.2.60.8**: Diagnose one model failure case.
**Exercise 2.2.60.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.2.60.1 - 2.2.60.9
...
Proceed to **Lesson 2.2.61: Preprocessing Pipelines - Part 61** when ready.
