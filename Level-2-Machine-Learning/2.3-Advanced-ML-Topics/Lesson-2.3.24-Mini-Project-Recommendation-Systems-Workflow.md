# Lesson 2.3.24: Mini-Project: Recommendation Systems Workflow

> Previous Lesson: [Lesson 2.3.23: Time Series Forecasting - Part 23](Lesson-2.3.23-Time-Series-Forecasting-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.3.23 | **Topic**: 2.3 Advanced ML Topics (Recommendation Systems)
...
**Exercise 2.3.24.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.3.24.2**: Train one baseline model.
**Exercise 2.3.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.3.24.4**: Add one preprocessing step in a pipeline.
**Exercise 2.3.24.5**: Compare two models on the same split.
**Exercise 2.3.24.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.3.24.7**: Add cross-validation and summarize variance.
**Exercise 2.3.24.8**: Diagnose one model failure case.
**Exercise 2.3.24.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.3.24.1 - 2.3.24.9
...
Proceed to **Lesson 2.3.25: MILESTONE TEST: 2.3 Advanced ML Topics Module 1** when ready.
