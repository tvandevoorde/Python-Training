...
> Previous Lesson: [Lesson 2.3.28: Recommendation Systems - Part 28](Lesson-2.3.28-Recommendation-Systems-Part-28.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.3.28 | **Topic**: 2.3 Advanced ML Topics (Imbalanced Learning)
...
- Explain the core principles of Imbalanced Learning - Part 29
...
Imbalanced Learning - Part 29 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Imbalanced Learning - Part 29 in real machine learning projects.
...
1. Clarify one concrete goal for: Imbalanced Learning - Part 29.
...
```python
LESSON_ID = "2.3.29"
LESSON_TOPIC = "Imbalanced Learning - Part 29"
...
**Exercise 2.3.29.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.3.29.2**: Train one baseline model.
**Exercise 2.3.29.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.3.29.4**: Add one preprocessing step in a pipeline.
**Exercise 2.3.29.5**: Compare two models on the same split.
**Exercise 2.3.29.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.3.29.7**: Add cross-validation and summarize variance.
**Exercise 2.3.29.8**: Diagnose one model failure case.
**Exercise 2.3.29.9**: Add one robustness check for edge cases.
...
**Lesson 2.3.30: Ensemble Strategies - Part 30**
...
- [ ] Complete exercises 2.3.29.1 - 2.3.29.9
...
Proceed to **Lesson 2.3.30: Ensemble Strategies - Part 30** when ready.
