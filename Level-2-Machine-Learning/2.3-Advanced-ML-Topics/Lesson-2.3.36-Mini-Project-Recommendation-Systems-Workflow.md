# Lesson 2.3.36: Mini-Project: Recommendation Systems Workflow

> Previous Lesson: [Lesson 2.3.35: Time Series Forecasting - Part 35](Lesson-2.3.35-Time-Series-Forecasting-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.3.35 | **Topic**: 2.3 Advanced ML Topics (Recommendation Systems)
...
**Exercise 2.3.36.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.3.36.2**: Train one baseline model.
**Exercise 2.3.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.3.36.4**: Add one preprocessing step in a pipeline.
**Exercise 2.3.36.5**: Compare two models on the same split.
**Exercise 2.3.36.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.3.36.7**: Add cross-validation and summarize variance.
**Exercise 2.3.36.8**: Diagnose one model failure case.
**Exercise 2.3.36.9**: Add one robustness check for edge cases.
...
**Lesson 2.3.37: Imbalanced Learning - Part 37**
...
- [ ] Complete exercises 2.3.36.1 - 2.3.36.9
...
Proceed to **Lesson 2.3.37: Imbalanced Learning - Part 37** when ready.
