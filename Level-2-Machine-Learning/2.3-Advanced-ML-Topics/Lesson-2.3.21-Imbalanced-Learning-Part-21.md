...
> Previous Lesson: [Lesson 2.3.20: Recommendation Systems - Part 20](Lesson-2.3.20-Recommendation-Systems-Part-20.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.3.20 | **Topic**: 2.3 Advanced ML Topics (Imbalanced Learning)
...
- Explain the core principles of Imbalanced Learning - Part 21
...
Imbalanced Learning - Part 21 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Imbalanced Learning - Part 21 in real machine learning projects.
...
1. Clarify one concrete goal for: Imbalanced Learning - Part 21.
...
```python
LESSON_ID = "2.3.21"
LESSON_TOPIC = "Imbalanced Learning - Part 21"
...
**Exercise 2.3.21.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.3.21.2**: Train one baseline model.
**Exercise 2.3.21.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.3.21.4**: Add one preprocessing step in a pipeline.
**Exercise 2.3.21.5**: Compare two models on the same split.
**Exercise 2.3.21.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.3.21.7**: Add cross-validation and summarize variance.
**Exercise 2.3.21.8**: Diagnose one model failure case.
**Exercise 2.3.21.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.3.21.1 - 2.3.21.9
...
Proceed to **Lesson 2.3.22: Ensemble Strategies - Part 22** when ready.
