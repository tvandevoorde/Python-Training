...
- Explain the core principles of Time Series Forecasting - Part 19
...
This lesson develops practical concepts for Time Series Forecasting - Part 19 in real machine learning projects.
...
**Exercise 2.3.19.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.3.19.2**: Train one baseline model.
**Exercise 2.3.19.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.3.19.4**: Add one preprocessing step in a pipeline.
**Exercise 2.3.19.5**: Compare two models on the same split.
**Exercise 2.3.19.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.3.19.7**: Add cross-validation and summarize variance.
**Exercise 2.3.19.8**: Diagnose one model failure case.
**Exercise 2.3.19.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.3.19.1 - 2.3.19.9
