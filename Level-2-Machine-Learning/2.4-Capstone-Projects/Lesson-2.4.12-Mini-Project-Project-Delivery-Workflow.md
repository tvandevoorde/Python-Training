# Lesson 2.4.12: Mini-Project: Project Delivery Workflow

> Previous Lesson: [Lesson 2.4.11: Business Problem Framing - Part 11](Lesson-2.4.11-Business-Problem-Framing-Part-11.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.4.11 | **Topic**: 2.4 Capstone Projects (Project Delivery)
...
**Exercise 2.4.12.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.4.12.2**: Train one baseline model.
**Exercise 2.4.12.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.4.12.4**: Add one preprocessing step in a pipeline.
**Exercise 2.4.12.5**: Compare two models on the same split.
**Exercise 2.4.12.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.4.12.7**: Add cross-validation and summarize variance.
**Exercise 2.4.12.8**: Diagnose one model failure case.
**Exercise 2.4.12.9**: Add one robustness check for edge cases.
...
**Lesson 2.4.13: Kaggle Competition Workflow - Part 13**
...
- [ ] Complete exercises 2.4.12.1 - 2.4.12.9
...
Proceed to **Lesson 2.4.13: Kaggle Competition Workflow - Part 13** when ready.
