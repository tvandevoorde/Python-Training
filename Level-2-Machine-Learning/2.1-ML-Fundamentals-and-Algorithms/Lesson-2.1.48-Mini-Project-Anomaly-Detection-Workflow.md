# Lesson 2.1.48: Mini-Project: Anomaly Detection Workflow

> Previous Lesson: [Lesson 2.1.47: Model Evaluation - Part 47](Lesson-2.1.47-Model-Evaluation-Part-47.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.1.47 | **Topic**: 2.1 ML Fundamentals and Algorithms (Anomaly Detection)
...
**Exercise 2.1.48.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.48.2**: Train one baseline model.
**Exercise 2.1.48.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.48.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.48.5**: Compare two models on the same split.
**Exercise 2.1.48.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.48.7**: Add cross-validation and summarize variance.
**Exercise 2.1.48.8**: Diagnose one model failure case.
**Exercise 2.1.48.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.1.48.1 - 2.1.48.9
...
Proceed to **Lesson 2.1.49: Problem Framing - Part 49** when ready.
