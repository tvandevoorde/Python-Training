...
> Previous Lesson: [Lesson 2.1.35: Feature Engineering - Part 35](Lesson-2.1.35-Feature-Engineering-Part-35.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.1.35 | **Topic**: 2.1 ML Fundamentals and Algorithms (Regression Models)
...
- Explain the core principles of Mini-Project: Regression Models Workflow
...
Mini-Project: Regression Models Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Regression Models Workflow in real machine learning projects.
...
1. Define target metric and baseline model for Mini-Project: Regression Models Workflow.
...
**Exercise 2.1.36.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.36.2**: Train one baseline model.
**Exercise 2.1.36.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.36.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.36.5**: Compare two models on the same split.
**Exercise 2.1.36.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.36.7**: Add cross-validation and summarize variance.
**Exercise 2.1.36.8**: Diagnose one model failure case.
**Exercise 2.1.36.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.37: Classification Models - Part 37**
...
- [ ] Complete exercises 2.1.36.1 - 2.1.36.9
...
Proceed to **Lesson 2.1.37: Classification Models - Part 37** when ready.
