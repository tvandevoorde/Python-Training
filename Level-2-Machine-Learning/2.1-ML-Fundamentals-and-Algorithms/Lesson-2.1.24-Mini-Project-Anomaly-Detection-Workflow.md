# Lesson 2.1.24: Mini-Project: Anomaly Detection Workflow

> Previous Lesson: [Lesson 2.1.23: Model Evaluation - Part 23](Lesson-2.1.23-Model-Evaluation-Part-23.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 2.1.23 | **Topic**: 2.1 ML Fundamentals and Algorithms (Anomaly Detection)
...
- Explain the core principles of Mini-Project: Anomaly Detection Workflow
...
Mini-Project: Anomaly Detection Workflow matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Mini-Project: Anomaly Detection Workflow in real machine learning projects.
...
1. Clarify one concrete goal for: Mini-Project: Anomaly Detection Workflow.
2. Implement the smallest working version for: 2.1 ML Fundamentals and Algorithms (Anomaly Detection).
3. Handle one invalid-input case explicitly.
4. Refactor repeated logic into a named function.

```python
LESSON_ID = "2.1.24"
LESSON_TOPIC = "Mini-Project: Anomaly Detection Workflow"
...
**Exercise 2.1.24.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.24.2**: Train one baseline model.
**Exercise 2.1.24.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.24.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.24.5**: Compare two models on the same split.
**Exercise 2.1.24.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.24.7**: Add cross-validation and summarize variance.
**Exercise 2.1.24.8**: Diagnose one model failure case.
**Exercise 2.1.24.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.25: MILESTONE TEST: 2.1 ML Fundamentals and Algorithms Module 1**
...
- [ ] Complete exercises 2.1.24.1 - 2.1.24.9
...
Proceed to **Lesson 2.1.25: MILESTONE TEST: 2.1 ML Fundamentals and Algorithms Module 1** when ready.
