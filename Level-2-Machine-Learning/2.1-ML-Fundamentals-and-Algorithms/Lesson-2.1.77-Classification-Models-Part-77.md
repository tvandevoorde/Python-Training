...
- Explain the core principles of Classification Models - Part 77
...
This lesson develops practical concepts for Classification Models - Part 77 in real machine learning projects.
...
**Exercise 2.1.77.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.77.2**: Train one baseline model.
**Exercise 2.1.77.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.77.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.77.5**: Compare two models on the same split.
**Exercise 2.1.77.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.77.7**: Add cross-validation and summarize variance.
**Exercise 2.1.77.8**: Diagnose one model failure case.
**Exercise 2.1.77.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.1.77.1 - 2.1.77.9
