...
> Previous Lesson: [Lesson 2.1.96: Mini-Project: Anomaly Detection Workflow](Lesson-2.1.96-Mini-Project-Anomaly-Detection-Workflow.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 2.1.96 | **Topic**: 2.1 ML Fundamentals and Algorithms (Problem Framing)
...
- Explain the core principles of Problem Framing - Part 97
...
Problem Framing - Part 97 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Problem Framing - Part 97 in real machine learning projects.
...
1. Clarify one concrete goal for: Problem Framing - Part 97.
...
```python
LESSON_ID = "2.1.97"
LESSON_TOPIC = "Problem Framing - Part 97"
...
**Exercise 2.1.97.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.97.2**: Train one baseline model.
**Exercise 2.1.97.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.97.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.97.5**: Compare two models on the same split.
**Exercise 2.1.97.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.97.7**: Add cross-validation and summarize variance.
**Exercise 2.1.97.8**: Diagnose one model failure case.
**Exercise 2.1.97.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.98: Data Splitting - Part 98**
...
- [ ] Complete exercises 2.1.97.1 - 2.1.97.9
...
Proceed to **Lesson 2.1.98: Data Splitting - Part 98** when ready.
