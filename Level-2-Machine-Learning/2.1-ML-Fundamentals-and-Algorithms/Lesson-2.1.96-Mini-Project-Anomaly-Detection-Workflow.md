# Lesson 2.1.96: Mini-Project: Anomaly Detection Workflow

> Previous Lesson: [Lesson 2.1.95: Model Evaluation - Part 95](Lesson-2.1.95-Model-Evaluation-Part-95.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 2.1.95 | **Topic**: 2.1 ML Fundamentals and Algorithms (Anomaly Detection)
...
**Exercise 2.1.96.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.96.2**: Train one baseline model.
**Exercise 2.1.96.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.96.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.96.5**: Compare two models on the same split.
**Exercise 2.1.96.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.96.7**: Add cross-validation and summarize variance.
**Exercise 2.1.96.8**: Diagnose one model failure case.
**Exercise 2.1.96.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.97: Problem Framing - Part 97**
...
- [ ] Complete exercises 2.1.96.1 - 2.1.96.9
...
Proceed to **Lesson 2.1.97: Problem Framing - Part 97** when ready.
