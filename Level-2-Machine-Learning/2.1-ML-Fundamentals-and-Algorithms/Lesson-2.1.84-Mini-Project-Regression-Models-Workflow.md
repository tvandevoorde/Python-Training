# Lesson 2.1.84: Mini-Project: Regression Models Workflow

> Previous Lesson: [Lesson 2.1.83: Feature Engineering - Part 83](Lesson-2.1.83-Feature-Engineering-Part-83.md)

**Estimated Time**: 8 hours | **Difficulty**: Advanced  
**Prerequisites**: Lesson 2.1.83 | **Topic**: 2.1 ML Fundamentals and Algorithms (Regression Models)
...
**Exercise 2.1.84.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.84.2**: Train one baseline model.
**Exercise 2.1.84.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.84.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.84.5**: Compare two models on the same split.
**Exercise 2.1.84.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.84.7**: Add cross-validation and summarize variance.
**Exercise 2.1.84.8**: Diagnose one model failure case.
**Exercise 2.1.84.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.85: Classification Models - Part 85**
...
- [ ] Complete exercises 2.1.84.1 - 2.1.84.9
...
Proceed to **Lesson 2.1.85: Classification Models - Part 85** when ready.
