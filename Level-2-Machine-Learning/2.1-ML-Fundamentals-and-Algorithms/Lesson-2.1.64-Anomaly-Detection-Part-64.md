...
> Previous Lesson: [Lesson 2.1.63: Model Evaluation - Part 63](Lesson-2.1.63-Model-Evaluation-Part-63.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.1.63 | **Topic**: 2.1 ML Fundamentals and Algorithms (Anomaly Detection)
...
- Explain the core principles of Anomaly Detection - Part 64
...
Anomaly Detection - Part 64 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Anomaly Detection - Part 64 in real machine learning projects.
...
1. Clarify one concrete goal for: Anomaly Detection - Part 64.
...
```python
LESSON_ID = "2.1.64"
LESSON_TOPIC = "Anomaly Detection - Part 64"
...
**Exercise 2.1.64.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.64.2**: Train one baseline model.
**Exercise 2.1.64.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.64.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.64.5**: Compare two models on the same split.
**Exercise 2.1.64.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.64.7**: Add cross-validation and summarize variance.
**Exercise 2.1.64.8**: Diagnose one model failure case.
**Exercise 2.1.64.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.65: Problem Framing - Part 65**
...
- [ ] Complete exercises 2.1.64.1 - 2.1.64.9
...
Proceed to **Lesson 2.1.65: Problem Framing - Part 65** when ready.
