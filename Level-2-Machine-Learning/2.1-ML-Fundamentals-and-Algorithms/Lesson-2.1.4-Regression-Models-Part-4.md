...
> Previous Lesson: [Lesson 2.1.3: Feature Engineering - Part 3](Lesson-2.1.3-Feature-Engineering-Part-3.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 2.1.3 | **Topic**: 2.1 ML Fundamentals and Algorithms (Regression Models)
...
- Explain the core principles of Regression Models - Part 4
...
Regression Models - Part 4 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Regression Models - Part 4 in real machine learning projects.
...
1. Define target metric and baseline model for Regression Models - Part 4.
...
**Exercise 2.1.4.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.4.2**: Train one baseline model.
**Exercise 2.1.4.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.4.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.4.5**: Compare two models on the same split.
**Exercise 2.1.4.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.4.7**: Add cross-validation and summarize variance.
**Exercise 2.1.4.8**: Diagnose one model failure case.
**Exercise 2.1.4.9**: Add one robustness check for edge cases.
...
- [ ] Complete exercises 2.1.4.1 - 2.1.4.9
...
Proceed to **Lesson 2.1.5: Classification Models - Part 5** when ready.
