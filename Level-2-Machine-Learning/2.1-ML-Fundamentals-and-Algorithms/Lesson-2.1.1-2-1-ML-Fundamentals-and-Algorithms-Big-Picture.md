# Lesson 2.1.1: 2.1 ML Fundamentals and Algorithms: Big Picture

> Previous Lesson: [Sublevel Index](CURRICULUM-INDEX.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: LEVEL 1.4 | **Topic**: 2.1 ML Fundamentals and Algorithms (Problem Framing)
...
- Explain the core principles of 2.1 ML Fundamentals and Algorithms: Big Picture
...
2.1 ML Fundamentals and Algorithms: Big Picture matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for 2.1 ML Fundamentals and Algorithms: Big Picture in real machine learning projects.
...
1. Clarify one concrete goal for: 2.1 ML Fundamentals and Algorithms: Big Picture.
...
```python
LESSON_ID = "2.1.1"
LESSON_TOPIC = "2.1 ML Fundamentals and Algorithms: Big Picture"
...
**Exercise 2.1.1.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.1.2**: Train one baseline model.
**Exercise 2.1.1.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.1.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.1.5**: Compare two models on the same split.
**Exercise 2.1.1.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.1.7**: Add cross-validation and summarize variance.
**Exercise 2.1.1.8**: Diagnose one model failure case.
**Exercise 2.1.1.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.2: Data Splitting - Part 2**
...
- [ ] Complete exercises 2.1.1.1 - 2.1.1.9
...
Proceed to **Lesson 2.1.2: Data Splitting - Part 2** when ready.
