...
> Previous Lesson: [Lesson 2.1.11: Feature Engineering - Part 11](Lesson-2.1.11-Feature-Engineering-Part-11.md)

**Estimated Time**: 8 hours | **Difficulty**: Beginner  
**Prerequisites**: Lesson 2.1.11 | **Topic**: 2.1 ML Fundamentals and Algorithms (Regression Models)
...
**Exercise 2.1.12.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.12.2**: Train one baseline model.
**Exercise 2.1.12.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.12.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.12.5**: Compare two models on the same split.
**Exercise 2.1.12.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.12.7**: Add cross-validation and summarize variance.
**Exercise 2.1.12.8**: Diagnose one model failure case.
**Exercise 2.1.12.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.13: Classification Models - Part 13**
...
- [ ] Complete exercises 2.1.12.1 - 2.1.12.9
...
Proceed to **Lesson 2.1.13: Classification Models - Part 13** when ready.
