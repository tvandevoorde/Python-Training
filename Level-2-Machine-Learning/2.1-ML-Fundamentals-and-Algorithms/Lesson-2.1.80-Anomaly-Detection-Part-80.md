...
> Previous Lesson: [Lesson 2.1.79: Model Evaluation - Part 79](Lesson-2.1.79-Model-Evaluation-Part-79.md)

**Estimated Time**: 8 hours | **Difficulty**: Intermediate  
**Prerequisites**: Lesson 2.1.79 | **Topic**: 2.1 ML Fundamentals and Algorithms (Anomaly Detection)
...
- Explain the core principles of Anomaly Detection - Part 80
...
Anomaly Detection - Part 80 matters because it solves a recurring engineering problem and creates a reliable foundation for later lessons.
...
This lesson develops practical concepts for Anomaly Detection - Part 80 in real machine learning projects.
...
1. Clarify one concrete goal for: Anomaly Detection - Part 80.
...
```python
LESSON_ID = "2.1.80"
LESSON_TOPIC = "Anomaly Detection - Part 80"
...
**Exercise 2.1.80.1**: Split a toy dataset into train/test sets.
```python
from sklearn.model_selection import train_test_split
...
**Exercise 2.1.80.2**: Train one baseline model.
**Exercise 2.1.80.3**: Report one evaluation metric.

---

### Difficulty 2: Intermediate

**Exercise 2.1.80.4**: Add one preprocessing step in a pipeline.
**Exercise 2.1.80.5**: Compare two models on the same split.
**Exercise 2.1.80.6**: Explain metric tradeoffs in 3-5 sentences.

---

### Difficulty 3: Advanced

**Exercise 2.1.80.7**: Add cross-validation and summarize variance.
**Exercise 2.1.80.8**: Diagnose one model failure case.
**Exercise 2.1.80.9**: Add one robustness check for edge cases.
...
**Lesson 2.1.81: Problem Framing - Part 81**
...
- [ ] Complete exercises 2.1.80.1 - 2.1.80.9
...
Proceed to **Lesson 2.1.81: Problem Framing - Part 81** when ready.
