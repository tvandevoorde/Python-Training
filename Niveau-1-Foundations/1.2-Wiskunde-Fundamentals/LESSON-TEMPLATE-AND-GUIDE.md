# Lesson Template - Wiskunde Fundamentals

This template outlines the structure for all lessons in Niveau 1.2 (Wiskunde Fundamentals).
...
| Mini-Project (when specified) | 60 min (1 hr) | Integration + creativity |
...
### 1.2 Worked Examples
[Provide 2-4 examples, building complexity]
...
### 2.2 Worked Examples
[Code examples and numeric examples]
...
Proceed to **Lesson X.X.X** when ready.
```
...
- Start: Simple, concrete numeric examples
- Middle: Build complexity gradually
- End: Apply to ML or data contexts

### 2. Balance Theory with Practice
- ~40% explanation/theory
- ~60% examples, exercises, projects

### 3. Multiple Difficulty Levels
- Starter: single concept, guided
- Intermediate: combine 2-3 concepts
- Advanced: open-ended problem solving
...
- Show where concepts are used in ML
- Mini-projects solve actual problems
- Use data-focused examples

---

## Math-Specific Guidelines

- Start with intuition and visuals before formulas
- Use clear variable naming and units
- Validate formulas with small numeric examples
- Highlight common misconceptions
- Use Python/NumPy to confirm results
...
**File location:**
```
Niveau-1-Foundations/1.2-Wiskunde-Fundamentals/
```

---

**This template ensures consistency and quality across all 1.2 lessons.**
